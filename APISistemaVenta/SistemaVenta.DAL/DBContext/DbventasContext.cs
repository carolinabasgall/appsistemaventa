...
public partial class DbventasContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CE420C207");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F21CCAEEB");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483CD68A150");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A48D9918E2");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumberoD__471E421AFBD00886");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132206200B6");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76A52BF129");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6BB3D35B9");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561428FBE998");
